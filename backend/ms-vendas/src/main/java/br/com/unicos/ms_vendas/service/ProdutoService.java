...
import br.com.unicos.ms_vendas.mapper.ProdutoMapper;
import br.com.unicos.ms_vendas.model.Produto;
import br.com.unicos.ms_vendas.repository.ProdutoRepository;
...
public class ProdutoService extends BaseTenantService<Produto, Long> {
    ...
    @CircuitBreaker(name = "vendas-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "vendas-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "vendas-admin", fallbackMethod = "fallbackAdminVoid")
