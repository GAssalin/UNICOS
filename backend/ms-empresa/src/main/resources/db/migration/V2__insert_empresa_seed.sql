...
(3, 1,    'Empresa Gamma Ltda', 'Gamma', '11122233000155', 'FILIAL', 'INATIVA', 'SIMPLES_NACIONAL', '2019-03-15', 1003, 1, NOW(), 1, NOW(), TRUE),
(4, NULL, 'Empresa Delta ME', 'Delta', '55566677000188', 'MATRIZ', 'ATIVA', 'MEI', '2022-07-01', 1004, 1, NOW(), 1, NOW(), TRUE);

INSERT INTO empresa_configuracao (
    id, empresa_id, chave, valor, criado_por, criado_em, atualizado_por, atualizado_em, ativo
) VALUES
...
INSERT INTO empresa_contato (
    id, empresa_id, tipo_contato, valor, principal, criado_por, criado_em, atualizado_por, atualizado_em, ativo
) VALUES
...
INSERT INTO empresa_endereco (
    id, empresa_id, tipo_endereco, logradouro, numero, complemento, bairro, municipio, uf, cep, principal, criado_por, criado_em, atualizado_por, atualizado_em, ativo
) VALUES
...
INSERT INTO empresa_usuario (
    id, empresa_id, usuario_id, perfil, criado_por, criado_em, atualizado_por, atualizado_em, ativo
) VALUES
