...
import br.com.unicos.ms_pagamentos.dto.categoria.CategoriaProdutoCreateRequest;
import br.com.unicos.ms_pagamentos.dto.categoria.CategoriaProdutoResponse;
import br.com.unicos.ms_pagamentos.dto.categoria.CategoriaProdutoResumoResponse;
import br.com.unicos.ms_pagamentos.dto.categoria.CategoriaProdutoUpdateRequest;
import br.com.unicos.ms_pagamentos.mapper.CategoriaProdutoMapper;
import br.com.unicos.ms_pagamentos.model.CategoriaProduto;
import br.com.unicos.ms_pagamentos.repository.CategoriaProdutoRepository;
...
public class CategoriaProdutoService extends BaseTenantService<CategoriaProduto, Long> {
    ...
    @CircuitBreaker(name = "pagamentos-categoria-produto-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-categoria-produto-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "pagamentos-categoria-produto-admin", fallbackMethod = "fallbackAdminVoid")
