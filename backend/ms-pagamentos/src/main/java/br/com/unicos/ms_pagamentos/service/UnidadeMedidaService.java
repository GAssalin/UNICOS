...
import br.com.unicos.ms_pagamentos.mapper.UnidadeMedidaMapper;
...
public class UnidadeMedidaService extends BaseTenantService<UnidadeMedida, Long> {
    ...
    @CircuitBreaker(name = "pagamentos-unidade-medida-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-unidade-medida-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "pagamentos-unidade-medida-admin", fallbackMethod = "fallbackAdminVoid")
