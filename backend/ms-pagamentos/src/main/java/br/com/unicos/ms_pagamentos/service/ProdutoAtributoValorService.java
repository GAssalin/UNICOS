...
import br.com.unicos.ms_pagamentos.dto.produtoatributovalor.ProdutoAtributoValorCreateRequest;
import br.com.unicos.ms_pagamentos.dto.produtoatributovalor.ProdutoAtributoValorResponse;
import br.com.unicos.ms_pagamentos.dto.produtoatributovalor.ProdutoAtributoValorUpdateRequest;
import br.com.unicos.ms_pagamentos.mapper.ProdutoAtributoValorMapper;
import br.com.unicos.ms_pagamentos.model.ProdutoAtributoValor;
import br.com.unicos.ms_pagamentos.repository.ProdutoAtributoValorRepository;
...
public class ProdutoAtributoValorService extends BaseTenantService<ProdutoAtributoValor, Long> {
    ...
    @CircuitBreaker(name = "pagamentos-produto-atributo-valor-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-produto-atributo-valor-admin", fallbackMethod = "fallbackAdminList")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-produto-atributo-valor-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "pagamentos-produto-atributo-valor-admin", fallbackMethod = "fallbackAdminVoid")
    public void remover(Long id) {
        Long empresaId = TenantContext.getEmpresaId();
        repository.delete(buscarValor(id, empresaId));
    }

    @CircuitBreaker(name = "pagamentos-produto-atributo-valor-admin", fallbackMethod = "fallbackAdminVoid2")
