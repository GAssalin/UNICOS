...
import br.com.unicos.ms_pagamentos.dto.produtocodigobarras.ProdutoCodigoBarrasCreateRequest;
import br.com.unicos.ms_pagamentos.dto.produtocodigobarras.ProdutoCodigoBarrasResponse;
import br.com.unicos.ms_pagamentos.dto.produtocodigobarras.ProdutoCodigoBarrasUpdateRequest;
import br.com.unicos.ms_pagamentos.mapper.ProdutoCodigoBarrasMapper;
import br.com.unicos.ms_pagamentos.model.ProdutoCodigoBarras;
import br.com.unicos.ms_pagamentos.repository.ProdutoCodigoBarrasRepository;
...
public class ProdutoCodigoBarrasService extends BaseTenantService<ProdutoCodigoBarras, Long> {
    ...
    @CircuitBreaker(name = "pagamentos-produto-codigo-barras-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-produto-codigo-barras-admin", fallbackMethod = "fallbackAdminList")
    ...
    @CircuitBreaker(name = "pagamentos-produto-codigo-barras-admin", fallbackMethod = "fallbackAdminVoid")
    public void remover(Long id) {
        Long empresaId = TenantContext.getEmpresaId();
        repository.delete(buscarCodigo(id, empresaId));
    }

    @CircuitBreaker(name = "pagamentos-produto-codigo-barras-admin", fallbackMethod = "fallbackAdminVoid2")
