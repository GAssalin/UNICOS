...
import br.com.unicos.ms_pagamentos.mapper.MarcaProdutoMapper;
import br.com.unicos.ms_pagamentos.model.MarcaProduto;
import br.com.unicos.ms_pagamentos.repository.MarcaProdutoRepository;
...
public class MarcaProdutoService extends BaseTenantService<MarcaProduto, Long> {
    ...
    @CircuitBreaker(name = "pagamentos-marca-produto-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-marca-produto-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "pagamentos-marca-produto-admin", fallbackMethod = "fallbackAdminVoid")
