...
import br.com.unicos.ms_pagamentos.mapper.ProdutoTipoMapper;
import br.com.unicos.ms_pagamentos.model.ProdutoTipo;
import br.com.unicos.ms_pagamentos.repository.ProdutoTipoRepository;
...
public class ProdutoTipoService extends BaseTenantService<ProdutoTipo, Long> {
    ...
    @CircuitBreaker(name = "pagamentos-produto-tipo-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-produto-tipo-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "pagamentos-produto-tipo-admin", fallbackMethod = "fallbackAdminVoid")
