...
import br.com.unicos.ms_pagamentos.mapper.ProdutoAtributoMapper;
import br.com.unicos.ms_pagamentos.model.ProdutoAtributo;
import br.com.unicos.ms_pagamentos.repository.ProdutoAtributoRepository;
...
public class ProdutoAtributoService extends BaseTenantService<ProdutoAtributo, Long> {
    ...
    @CircuitBreaker(name = "pagamentos-produto-atributo-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-produto-atributo-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "pagamentos-produto-atributo-admin", fallbackMethod = "fallbackAdminVoid")
