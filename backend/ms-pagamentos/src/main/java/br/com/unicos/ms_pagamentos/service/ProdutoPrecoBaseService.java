...
import br.com.unicos.ms_pagamentos.mapper.ProdutoPrecoBaseMapper;
import br.com.unicos.ms_pagamentos.model.ProdutoPrecoBase;
import br.com.unicos.ms_pagamentos.repository.ProdutoPrecoBaseRepository;
...
public class ProdutoPrecoBaseService extends BaseTenantService<ProdutoPrecoBase, Long> {
    ...
    @CircuitBreaker(name = "pagamentos-produto-preco-base-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "pagamentos-produto-preco-base-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "pagamentos-produto-preco-base-admin", fallbackMethod = "fallbackAdminVoid")
    public void remover(Long id) {
        Long empresaId = TenantContext.getEmpresaId();
        repository.delete(buscarPreco(id, empresaId));
    }

    @CircuitBreaker(name = "pagamentos-produto-preco-base-admin", fallbackMethod = "fallbackAdminVoid2")
