...
import br.com.unicos.ms_compras.mapper.ProdutoTipoMapper;
import br.com.unicos.ms_compras.model.ProdutoTipo;
import br.com.unicos.ms_compras.repository.ProdutoTipoRepository;
...
public class ProdutoTipoService extends BaseTenantService<ProdutoTipo, Long> {
    ...
    @CircuitBreaker(name = "compras-produto-tipo-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "compras-produto-tipo-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "compras-produto-tipo-admin", fallbackMethod = "fallbackAdminVoid")
