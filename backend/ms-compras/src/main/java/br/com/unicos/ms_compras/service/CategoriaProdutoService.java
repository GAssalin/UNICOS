...
import br.com.unicos.ms_compras.dto.categoria.CategoriaProdutoCreateRequest;
import br.com.unicos.ms_compras.dto.categoria.CategoriaProdutoResponse;
import br.com.unicos.ms_compras.dto.categoria.CategoriaProdutoResumoResponse;
import br.com.unicos.ms_compras.dto.categoria.CategoriaProdutoUpdateRequest;
import br.com.unicos.ms_compras.mapper.CategoriaProdutoMapper;
import br.com.unicos.ms_compras.model.CategoriaProduto;
import br.com.unicos.ms_compras.repository.CategoriaProdutoRepository;
...
public class CategoriaProdutoService extends BaseTenantService<CategoriaProduto, Long> {
    ...
    @CircuitBreaker(name = "compras-categoria-produto-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "compras-categoria-produto-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "compras-categoria-produto-admin", fallbackMethod = "fallbackAdminVoid")
