...
import br.com.unicos.ms_compras.mapper.MarcaProdutoMapper;
import br.com.unicos.ms_compras.model.MarcaProduto;
import br.com.unicos.ms_compras.repository.MarcaProdutoRepository;
...
public class MarcaProdutoService extends BaseTenantService<MarcaProduto, Long> {
    ...
    @CircuitBreaker(name = "compras-marca-produto-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "compras-marca-produto-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "compras-marca-produto-admin", fallbackMethod = "fallbackAdminVoid")
