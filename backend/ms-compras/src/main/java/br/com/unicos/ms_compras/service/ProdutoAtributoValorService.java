...
import br.com.unicos.ms_compras.dto.produtoatributovalor.ProdutoAtributoValorCreateRequest;
import br.com.unicos.ms_compras.dto.produtoatributovalor.ProdutoAtributoValorResponse;
import br.com.unicos.ms_compras.dto.produtoatributovalor.ProdutoAtributoValorUpdateRequest;
import br.com.unicos.ms_compras.mapper.ProdutoAtributoValorMapper;
import br.com.unicos.ms_compras.model.ProdutoAtributoValor;
import br.com.unicos.ms_compras.repository.ProdutoAtributoValorRepository;
...
public class ProdutoAtributoValorService extends BaseTenantService<ProdutoAtributoValor, Long> {
    ...
    @CircuitBreaker(name = "compras-produto-atributo-valor-admin", fallbackMethod = "fallbackAdmin")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "compras-produto-atributo-valor-admin", fallbackMethod = "fallbackAdminList")
    ...
    @Transactional(readOnly = true)
    @CircuitBreaker(name = "compras-produto-atributo-valor-admin", fallbackMethod = "fallbackAdminPage")
    ...
    @CircuitBreaker(name = "compras-produto-atributo-valor-admin", fallbackMethod = "fallbackAdminVoid")
    public void remover(Long id) {
        Long empresaId = TenantContext.getEmpresaId();
        repository.delete(buscarValor(id, empresaId));
    }

    @CircuitBreaker(name = "compras-produto-atributo-valor-admin", fallbackMethod = "fallbackAdminVoid2")
